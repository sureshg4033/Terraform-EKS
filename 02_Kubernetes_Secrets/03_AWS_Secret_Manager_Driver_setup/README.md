# Section 03: Install AWS Secrets and Configuration Provider (ASCP) for Amazon EKS
...
![AWS Secrets Manager for AWS EKS Cluster](images/01-AWS-Secrets-Manager-for-EKS.png)
...
![Why Helm?](images/02-Why-Helm.png)

---

![Helm Benefits](images/03-Helm-Benefits.png)
...
aws iam attach-role-policy --role-name catalog-db-secrets-role --policy-arn arn:aws:iam::851563870286:policy/catalog-db-secret-policy
```
