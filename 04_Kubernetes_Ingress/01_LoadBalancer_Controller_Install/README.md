...
![Architecture Overview](../images/01-01-AWS-LoadBalancer-Contoller-Architecture.png)

---

### Ingress and Retail Store Sample Application
![Ingress and Retail Store Sample Application](../images/01-02-Ingress-and-RetaiStore-App.png)
